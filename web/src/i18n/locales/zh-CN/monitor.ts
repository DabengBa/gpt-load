export default {
  monitor: {
    ...
    schedule: {
      ...
      protocols: {
        'openai-completions': 'OpenAI 对话补全',
        'openai-responses': 'OpenAI Responses',
        'openai-images': 'OpenAI 图片',
        'openai-embeddings': 'OpenAI 向量',
        anthropic: 'Anthropic',
        gemini: 'Gemini',
      },
      operations: {
      ...
      detail: {
        ...
        unknownRouteStrategy: '未知路由策略',
        unknownBreakerSource: '未知来源',
        nativeRoute: '原生路由',
        draftPreview: '草稿预览',
        observedShare: '服务端观测',
      },
