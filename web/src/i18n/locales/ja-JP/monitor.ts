export default {
  monitor: {
    ...
    schedule: {
      ...
      protocols: {
        'openai-completions': 'OpenAI チャット補完',
        'openai-responses': 'OpenAI Responses',
        'openai-images': 'OpenAI 画像',
      ...
      index: {
        title: 'モデルスケジュール一覧',
        refresh: '更新',
        loading: 'モデルスケジュール一覧を読み込み中…',
        failed: 'モデルスケジュール一覧を読み込めません。',
        empty: 'スケジュール可能なモデルがありません。',
        candidates: '候補',
        groups: 'グループ',
        fallback: 'フォールバックあり',
        cooldown: 'クールダウン',
        ...
        select: '詳細を表示',
        eyebrow: 'ルート制御',
        routeExceptions: 'ルート例外',
      },
      detail: {
        title: 'スケジュール詳細',
        loading: 'スケジュール詳細を読み込み中…',
        failed: 'スケジュール詳細を読み込めません。',
        refresh: '更新',
        observed: '観測',
        ...
        unknownRouteStrategy: '不明なルート戦略',
        unknownBreakerSource: '不明なソース',
        nativeRoute: 'ネイティブルート',
        draftPreview: 'ドラフトプレビュー',
        observedShare: 'サーバー観測値',
      },
      routeStrategies: {
