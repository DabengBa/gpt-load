export default {
  monitor: {
    ...
    modelProbe: {
      ...
      description:
        'Sends one minimal real upstream request per target and records the result in the request log.',
      button: 'Probe',
      ...
      reason: {
        ...
        probe_incompatible: 'This model cannot be probed in this group',
