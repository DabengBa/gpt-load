  ...
  monitor: {
    ...
    health: {
      ...
      problems: {
        ...
        manualProbeRecovery: 'Manual probe available',
        manualProbeHint: 'Use the explicit credential test; recovery is not automatic',
        manualRestoreRecovery: 'Manual recovery required',
        manualRestoreHint:
          'Use an explicit credential test and restore action; no automatic recovery',
