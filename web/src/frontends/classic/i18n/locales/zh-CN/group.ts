export default {
  ...
  group: {
    ...
    modelEditor: {
      ...
      alias: '对外别名',
      pricing: '定价',
      testAliasAndPricing: '测试别名 / 定价',
      testAlias: '测试别名',
      testAliasPending: '保存后生成',
      actions: '操作',
      search: '搜索模型或别名',
      clearSearch: '清空模型搜索',
    ...
    settings: {
      ...
      base: {
        ...
        channel: '渠道',
        channelHelp: '只要目标渠道支持现有设置，就可以切换渠道。',
      ...
      runtime: {
        ...
        reasoningStatusFilterHelp:
          '仅移除 Responses 输入中 reasoning 项的 status 字段，保留消息和工具调用的 status。',
    ...
    credentials: {
      ...
      test: {
        ...
        title: '测试连接',
        description:
          '将使用此密钥发送一次最小真实上游请求，可能产生少量费用；测试成功后，仅当测试时的状态仍未变化才会立即恢复此凭据。',
        loading: '正在测试 {mask}…',
        outcome: {
          passed: '测试通过',
          failed: '测试未通过',
        ...
        close: '关闭',
        recovered: '密钥已立即恢复，并重新参与调度。',
        alreadyAvailable: '密钥本来就可用，无需改变恢复状态。',
        requestFailed: '无法完成测试，请稍后重试。',
      },
      recovery: {
        none: '无需恢复',
        cooldown: '冷却结束后自动恢复',
        scheduled_release: '本地拉黑延迟结束后恢复',
        manual: '需手动恢复',
        at: '将于 {time} 自动恢复',
      },
      failure: {
