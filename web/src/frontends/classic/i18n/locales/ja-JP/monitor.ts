export default {
  monitor: {
    ...
    modelProbe: {
      ...
      loading: '疎通確認中…',
      requestFailed: '疎通確認リクエストに失敗しました。完了済みの結果は保持されます。',
      stopped: '停止しました。完了済みの結果は保持されます。',
      progress: '{completed}/{total} 完了',
      summary: '成功 {passed} · 失敗 {failed} · 判定不可 {inconclusive}',
      close: '閉じる',
      stop: '停止',
      viewLog: 'ログを表示',
      credential: '使用した認証情報 {credential}',
      latency: '{value} ミリ秒',
      notExecuted: '上流リクエストを送信していないため、リクエスト ID はありません',
      recovered: '直ちに復旧しました',
      recoveryNotNeeded: '復旧状態の変更は不要でした',
      unknownValue: '—',
      disabledBadge: '無効',
      disabledScope: {
      ...
      reason: {
        invalid_credential: '認証情報が無効',
        model_unavailable: 'モデルを利用できません',
        rate_limited: 'レート制限',
        timeout: '上流タイムアウト',
        upstream_error: '上流サービスでエラーが発生',
        probe_incompatible:
          '選択したプロトコルまたはリクエストがこのターゲットと互換性がありません',
        no_answer: '上流から利用可能な回答テキストが返りませんでした',
        invalid_response: '上流レスポンスが選択したプロトコルに適合しません',
        unknown: '理由不明',
        target_unavailable: 'グループまたはモデルが存在しません',
        no_schedulable_credential: 'スケジュール可能な認証情報がありません',
      },
      routeMode: {
        native: 'ネイティブ',
        converted: '変換',
      ...
      toggle: {
        title: '疎通結果に基づくグループの有効化切替',
        hint: '有効状態を切り替えるグループを選択してください。適用後は結果に応じて有効化または無効化されます。',
        enablePassed: '成功したものをすべて有効化',
        disableNotPassed: '失敗・判定不可をすべて無効化',
        reset: '元の状態に戻す',
        apply: '適用',
        applied: '疎通結果に基づき {count} 件のグループを更新しました',
        applyFailed: '適用に失敗しました。再度お試しください。',
        noChanges: '変更が必要なグループはありません。',
        groupEnabled: '有効',
        groupDisabled: '無効',
      },
    },
    health: {
      ...
      overview: {
        ...
        blacklisted: 'ブラックリスト',
        blacklistedRecovery: 'ローカルのブラックリスト遅延後に自動で解放',
      ...
      problems: {
        ...
        scheduledReleaseRecovery: '約 {time} 後に解放',
        scheduledReleaseHint: 'ローカルのブラックリスト遅延後にスケジュールへ復帰',
      ...
      recovery: {
        ...
        scheduledRelease: 'ブラックリストのスケジュール解放',
        recoversAt: '自動回復時刻',
        seconds: '{seconds} 秒',
    ...
    usage: {
      ...
      filters: {
        ...
        deletedOrUnknownGroup: '削除済みまたは不明なグループ',
        refresh: '更新',
        apply: '適用',
        reset: 'リセット',
        applied: '適用中のフィルター',
    ...
    inspector: {
      ...
      form: {
        ...
        missingAccessKeyOption: '存在しないアクセスキー',
        submit: '現在のルートを検査',
      },
      accessKeyStatus: {
        active: '有効',
      ...
      groups: {
        ...
        fallbackTier: 'フォールバックレイヤー',
        entryCooldown: 'エントリcoolダウン終了',
      ...
      reasons: {
        ...
        entry_disabled: 'ルートエントリは無効です',
        entry_blacklisted: 'ルートエントリはブラックリスト登録中です',
        entry_cooldown: 'ルートエントリはクールダウン中です',
        entry_weight_zero: 'ルートエントリの重みが 0 です',
        tier_demoted: 'フォールバック優先度レイヤーで待機中です',
        unknown: '不明なルート理由',
      },
    },
    schedule: {
      panel: {
        ...
        selectModel: 'モデルを選択',
        selectMode: 'モードを選択',
        loadingOptions: 'アクセスキーを読み込み中…',
        optionsFailed: 'アクセスキーを読み込めません。',
        contextRequired: '完全なスケジュールコンテキストを選択してください',
        kicker: 'モデルスケジュールセンター',
        contextReady: 'コンテキスト準備完了',
        context: 'スケジュールコンテキスト',
        retry: '再試行',
        indexFailed: 'モデルスケジュール一覧を読み込めません。',
        detailFailed: 'モデルスケジュール詳細を読み込めません。',
      },
      modes: {
        all: 'すべての候補',
        primary: 'プライマリのみ',
      ...
      detail: {
        title: 'スケジュール詳細',
        loading: 'スケジュール詳細を読み込み中…',
        refresh: '更新',
        stale: '古い観測結果を表示しています。',
        routeUnavailable: '現在のルートは利用できません。',
        group: 'グループ',
        ...
        cooldown: 'クールダウン中',
        blacklisted: 'ブラックリスト',
        scheduledRelease: 'ブラックリスト解放',
        failures: '回の失敗',
        recover: '回復',
        invalidValue: '有効な値を入力してください。',
        derivedReadOnly: '派生エントリは読み取り専用です',
        save: '保存',
        discard: '変更を破棄',
        unsaved: '未保存の変更',
        saved: '保存しました',
        ...
        refreshToResolve: '更新して解決',
        recoverFailed: '回復に失敗しました。',
        noEntries: 'エントリがありません。',
        unknownReason: '不明なルート理由',
        draftPreview: 'ドラフトプレビュー',
        toggleEnabled: 'エントリを切り替え',
        toggleFailed: 'エントリの有効状態を更新できません。',
        enabled: '有効',
        disabled: '無効',
        calls24h: '24 時間の呼び出し',
        successRate24h: '成功率',
        ...
        sourceEntry: 'エントリ上書き',
        sourceClient: 'クライアント要求',
        sourceProviderDefault: 'プロバイダー既定値',
        editDetails: '詳細を編集',
        hideDetails: '詳細を閉じる',
        groupDisabled: 'グループ無効',
        unsupportedEffortValue: '{value}（未対応）',
      },
      reasons: {
        access_key_disabled: 'アクセスキーは無効です',
        access_key_expired: 'アクセスキーは期限切れです',
        protocol_filtered: 'アクセスキーフィルターがこのプロトコルを除外しました',
        model_filtered: 'アクセスキーフィルターがこのモデルを除外しました',
        model_required_by_filter: 'アクセスキーフィルターによりモデルの指定が必要です',
        operation_unsupported: 'チャネルはこの操作をサポートしていません',
        native_route_required: 'このリクエストにはネイティブルートが必要です',
        no_route_target: '一致するルート先がありません',
        group_disabled: 'グループは無効です',
        group_filtered: 'アクセスキーフィルターがこのグループを除外しました',
        no_available_group: '現在ルート可能な候補グループがありません',
        no_credentials: 'グループにランタイム認証情報がありません',
        credential_blacklisted: '認証情報はブラックリストに登録されています',
        credential_cooldown: '認証情報はクールダウン中です',
        credential_auth_unavailable: 'サブスクリプション認証を利用できません',
        credential_not_allowed: 'この認証情報はリクエストから除外されています',
        no_available_credential: 'グループに利用可能な認証情報がありません',
        entry_disabled: 'ルートエントリは無効です',
        entry_blacklisted: 'ルートエントリはブラックリスト登録中です',
        entry_cooldown: 'ルートエントリはクールダウン中です',
        entry_weight_zero: 'ルートエントリのウェイトがゼロです',
        tier_demoted: 'フォールバック優先度レイヤーで待機中です',
      },
    },
    logs: {
      ...
      filters: {
        ...
        searchClientModels: 'クライアントモデルを検索',
        anyClientModel: 'すべてのクライアントモデル',
        noMatches: '一致する項目がありません',
        upstreamModel: 'いずれかの試行のアップストリームモデル',
        accessKey: 'アクセスキー',
        affinityKey: 'アフィニティスコープキー',
        ...
        appliedModelConsistency: '応答モデル {value}',
        appliedOperation: '操作 {value}',
        appliedAccessKey: 'アクセスキー {value}',
        appliedAffinityKey: 'アフィニティスコープキー {value}',
      ...
      errors: {
        ...
        affinityKey: '正規の 16 + **** + 16 文字のスコープキーを入力してください。',
      },
      deletedRef: '削除済み · #{id}',
      none: 'なし',
      yes: 'はい',
      ...
      filterAffinityKey: 'アフィニティスコープキー {value} のログのみ表示',
      ...
      drawer: {
        ...
        keyReason: '主な原因',
        keyReasonFromAttempt: '主な原因 · 試行 #{sequence}',
        requestErrorCode: '最終エラーコード',
      ...
      affinitySourceLabel: 'アフィニティのソース：{source}',
      affinityStateLabel: 'アフィニティの状態：{state}',
      continuityHit: '継続：適用済み',
      affinitySource: {
        none: 'なし',
      ...
      affinityState: {
        ...
        cache_miss: 'アフィニティのバインディングなし',
        hit: 'アフィニティのバインディング解決済み（永続ストアからの復元を含む）',
        group_disabled: 'グループがアフィニティを無効化',
        target_unavailable: '対象クレデンシャル利用不可',
        cache_unavailable: 'アフィニティ解決不可（キャッシュ・設定・ストレージ）',
      },
      reasoning: {
        compact: '[{value}]',
        disabled: '[off]',
