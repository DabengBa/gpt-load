export default {
  monitor: {
    ...
    modelProbe: {
      ...
      loading: 'Probing…',
      requestFailed: 'The probe request failed; completed results are kept.',
      stopped: 'Stopped. Completed results are kept.',
      progress: '{completed}/{total} complete',
      summary: '{passed} passed · {failed} failed · {inconclusive} inconclusive',
      close: 'Close',
      stop: 'Stop',
      viewLog: 'View log',
      credential: 'Used credential {credential}',
      latency: '{value} ms',
      notExecuted: 'No upstream request was sent, so there is no request ID',
      recovered: 'Recovered immediately',
      recoveryNotNeeded: 'No recovery change was needed',
      unknownValue: '—',
      ...
      reason: {
        ...
        target_unavailable: 'Group or model does not exist',
        no_schedulable_credential: 'No schedulable credential right now',
      },
      routeMode: {
        native: 'Native',
        converted: 'Converted',
      ...
      toggle: {
        title: 'Adjust group switches by probe result',
        hint: 'Select the groups whose enabled state should change; applied changes enable or disable them by result.',
        enablePassed: 'Enable all passed',
        disableNotPassed: 'Disable all failed / inconclusive',
        reset: 'Restore original',
        apply: 'Apply',
        applied: 'Updated {count} groups based on probe results',
        applyFailed: 'Failed to apply. Please try again.',
        noChanges: 'No groups need to change.',
    ...
    health: {
      ...
      overview: {
        ...
        blacklistedRecovery: 'Released automatically after the local blacklist delay',
      ...
      problems: {
        ...
        scheduledReleaseRecovery: 'Returns in about {time}',
        scheduledReleaseHint: 'Returns to scheduling after the local blacklist delay',
      ...
      recovery: {
        ...
        scheduledRelease: 'Scheduled blacklist release',
    ...
    usage: {
      ...
      filters: {
        ...
        deletedOrUnknownGroup: 'Deleted or unknown Group',
        refresh: 'Refresh',
        apply: 'Apply',
        reset: 'Reset',
    ...
    inspector: {
      ...
      form: {
        ...
        accessKeyOption: '{name} · {status}',
        missingAccessKeyOption: 'Missing access key',
      ...
      groups: {
        ...
        entryCooldown: 'Entry cooldown until',
      ...
      reasons: {
        ...
        entry_disabled: 'Route entry is disabled',
        entry_blacklisted: 'Route entry is blacklisted',
        entry_cooldown: 'Route entry is cooling down',
        entry_weight_zero: 'Route entry weight is zero',
        tier_demoted: 'Standing by in a fallback priority tier',
    ...
    schedule: {
      panel: {
        ...
        loadingOptions: 'Loading access keys…',
        optionsFailed: 'Unable to load access keys.',
        contextRequired: 'Select a complete scheduling context first',
        kicker: 'MODEL DISPATCH CENTER',
        contextReady: 'Context ready',
        context: 'Scheduling context',
        retry: 'Retry',
        indexFailed: 'Unable to load the model schedule index.',
        detailFailed: 'Unable to load model schedule details.',
      },
      modes: {
        all: 'All candidates',
      ...
      detail: {
        ...
        refresh: 'Refresh',
        stale: 'Showing an older observation.',
        routeUnavailable: 'The current route is unavailable.',
        group: 'Group',
        ...
        cooldown: 'Cooling down',
        blacklisted: 'Blacklisted',
        scheduledRelease: 'Blacklist release',
        failures: 'failures',
        recover: 'Recover',
        invalidValue: 'Enter a valid value.',
        derivedReadOnly: 'Derived entry is read-only',
        save: 'Save',
        discard: 'Discard changes',
        unsaved: 'Unsaved changes',
        saved: 'Saved',
        saveFailed: 'Save failed.',
        conflict: 'The configuration changed. Refresh and try again.',
        refreshToResolve: 'Refresh to resolve',
        recoverFailed: 'Recovery failed.',
        noEntries: 'No entries are available.',
        unknownReason: 'Unknown route reason',
        draftPreview: 'Draft preview',
        toggleEnabled: 'Toggle entry',
        toggleFailed: 'Unable to update entry enabled state.',
        enabled: 'Enabled',
        disabled: 'Disabled',
        calls24h: '24h calls',
        ...
        sourceEntry: 'Entry override',
        sourceClient: 'Client request',
        sourceProviderDefault: 'Provider default',
        editDetails: 'Edit details',
        hideDetails: 'Hide details',
        groupDisabled: 'Group disabled',
        unsupportedEffortValue: '{value} (unsupported)',
      },
      reasons: {
        access_key_disabled: 'Access key is disabled',
        access_key_expired: 'Access key is expired',
        protocol_filtered: 'Access key filters exclude this protocol',
        model_filtered: 'Access key filters exclude this model',
        model_required_by_filter: 'A model is required by the access key filter',
        operation_unsupported: 'The channel does not support this operation',
        native_route_required: 'This request requires a native route',
        no_route_target: 'No matching route target exists',
        group_disabled: 'Group is disabled',
        group_filtered: 'Access key filters exclude this Group',
        no_available_group: 'No candidate Group is currently routable',
        no_credentials: 'Group has no runtime credentials',
        credential_blacklisted: 'Credential is blacklisted',
        credential_cooldown: 'Credential is cooling down',
        credential_auth_unavailable: 'Subscription authentication is unavailable',
        credential_not_allowed: 'This credential is excluded from the request',
        no_available_credential: 'Group has no available credential',
        entry_disabled: 'Route entry is disabled',
        entry_blacklisted: 'Route entry is blacklisted',
        entry_cooldown: 'Route entry is cooling down',
        entry_weight_zero: 'Route entry weight is zero',
    ...
    logs: {
      ...
      filters: {
        ...
        searchClientModels: 'Search client models',
        anyClientModel: 'Any client model',
        ...
        modelConsistencyLabel: 'Returned model',
        ...
        appliedModelConsistency: 'Returned model {value}',
        appliedOperation: 'Operation {value}',
        appliedAccessKey: 'Access key {value}',
        appliedAffinityKey: 'Affinity scope key {value}',
      ...
      errors: {
        ...
        affinityKey: 'Enter the canonical 16 + **** + 16 character scope key.',
      },
      ...
      drawer: {
        ...
        keyReasonFromAttempt: 'Key reason · Attempt #{sequence}',
        requestErrorCode: 'Final error code',
